         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <span class="toggle_icon" onclick="openNav()"><img src="{{ asset('home/images/toggle-icon.webp') }}"></span>
                  <div class="dropdown">
                  ...
                  <div class="header_box">
                     ...
                     <div class="login_menu">
                        <ul>
                           <li><a href="#">
                              <i class="fa fa-shopping-cart" style="font-size:30px;color:black" aria-hidden="true"></i>
                              <span class="padding_10">Cart</span></a>
                           </li>
                           <li><a href="#">
                              <i class="fa fa-user" style="font-size:30px;color:black" aria-hidden="true"></i>
                              <span>Cart</span></a>
                           </li>
                        </ul>
                     </div>
